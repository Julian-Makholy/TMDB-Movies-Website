<div class="relative mt-3 md:mt-0" x-data="{ isOpen: true }" wire:click.away="isOpen = false">
    <input
        @model.debounce.500ms="search"
        type="text"
        ...
        "
        wire:focus="isOpen = true"
        wire:keydown="isOpen = true"
        wire:keydown.escape.window="isOpen = false"
        wire:keydown.shift.tab="isOpen = false"
    >
                    ...
                    @foreach ($searchResults as $result)
                        <li class="border-b border-gray-700">
                            <a
                                ...
                                @if ($loop->last) wire:keydown.tab="isOpen = false" @endif
                            >
